...
import { DocumentContainer, SPSHeader, SPSFooter, TableRow, TextAreaBlock } from './InstrumentaisShared';
            ...
            <div className="mb-4 flex justify-between items-center px-2 print:hidden">
                ...
                <div className="flex gap-2">
                    ...
                    >
                        ...
                        <span className="font-bold text-[10px] uppercase tracking-wider">Importar Documento (PDF/Word)</span>
                    </button>
...
// Componentes comuns movidos para InstrumentaisShared.tsx
