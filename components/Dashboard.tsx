...
const Dashboard: React.FC<DashboardProps> = ({ user }) => {
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  // 🖼️ PAINEL UNIFICADO — Todos veem os pilares
  // Admin vê Visão Consolidada no final
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  const pilares = [
    {
  ...
  return (
    <section className="p-4 md:p-8 animate-fade-in bg-gradient-to-b from-[#FDE8C8]/40 to-[#E0F7F3]/30 min-h-screen space-y-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-10">
            <div>
              <span className="inline-block bg-gradient-to-r from-[#00BFA6] to-[#26D9C0] text-white text-[10px] font-black uppercase tracking-[0.2em] px-5 py-2.5 rounded-full mb-4 shadow-lg shadow-[#00BFA6]/40">
                <i className="fa-solid fa-child-reaching mr-2"></i>{isAdmin ? 'Painel do Gestor' : 'Painel Profissional'}
              </span>
            ...
            <div className="shrink-0 bg-gradient-to-br from-[#FDE8C8]/50 to-white border-2 border-[#F4C542]/40 rounded-2xl p-4 text-center shadow-lg shadow-[#F4C542]/20">
              <p className="text-[9px] font-black text-[#00BFA6] uppercase tracking-widest mb-1">{isAdmin ? 'Gestão Central' : 'Sua Unidade'}</p>
              <p className="text-sm font-black text-[#728EAD]">{isAdmin ? 'Todas as Unidades' : (user?.unit || 'Não definida')}</p>
              <p className="text-[10px] font-bold text-slate-400 mt-1">{user?.name} {user?.crp ? `• CRP ${user.crp}` : ''}</p>
            </div>
          </div>
      ...
      {/* ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ */}
      {/* 📊 VISÃO CONSOLIDADA — Somente Admin (no final)  */}
      {/* ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ */}
      {isAdmin && (
        <>
